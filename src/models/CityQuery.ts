...
export class Convert {
  public static toCity(json: string): CityQuery {
...
const typeMap: any = {
  ...
  "Result": o([
    ...
    { json: "locations", js: "locations", typ: 0 },
    { json: "firstUpdated", js: "firstUpdated", typ: Date },
    { json: "lastUpdated", js: "lastUpdated", typ: Date },
    { json: "parameters", js: "parameters", typ: a("") },
  ], false),
};
